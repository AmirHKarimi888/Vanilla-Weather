...
class TodayWeatherStatusIcon extends AppStructure {
    ...
    render () {
        ...
        return /*html*/`
        ${store.weatherData?.list[0]?.weather[0]?.main.toLowerCase() === "clear" ? 
        ...
        ${store.weatherData?.list[0]?.weather[0]?.main.toLowerCase() === "rain" ? 
        ...
        ${store.weatherData?.list[0]?.weather[0]?.main.toLowerCase() === "snow" ? 
        ...
        ${store.weatherData?.list[0]?.weather[0]?.main.toLowerCase() === "clouds" ? 
